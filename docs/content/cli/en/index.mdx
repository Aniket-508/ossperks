...
- [list](/cli/commands/list) — browse all programs
- [show](/cli/commands/show) — view program details
- [check](/cli/commands/check) — auto-check your repo eligibility
- [search](/cli/commands/search) — find programs by keyword
- [categories](/cli/commands/categories) — list available categories
