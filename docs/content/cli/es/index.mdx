...
- <DynamicLink href="/[lang]/cli/list">list</DynamicLink> — explorar todos los programas
- <DynamicLink href="/[lang]/cli/show">show</DynamicLink> — ver detalles del programa
- <DynamicLink href="/[lang]/cli/check">check</DynamicLink> — verificar automáticamente la
  elegibilidad de tu repositorio
- <DynamicLink href="/[lang]/cli/search">search</DynamicLink> — buscar programas por
  palabra clave
