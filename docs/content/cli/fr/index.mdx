...
- <DynamicLink href="/[lang]/cli/show">show</DynamicLink> — voir les détails du programme
- <DynamicLink href="/[lang]/cli/check">check</DynamicLink> — vérifier automatiquement l'éligibilité de votre
  dépôt
- <DynamicLink href="/[lang]/cli/search">search</DynamicLink> — rechercher des programmes par
  mot-clé
- <DynamicLink href="/[lang]/cli/categories">categories</DynamicLink> — parcourir
  par catégorie (interactif dans un TTY)
