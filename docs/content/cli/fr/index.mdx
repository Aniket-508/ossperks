...
1. Lit le champ `repository` du fichier `package.json` dans le répertoire courant
2. Se replie sur l'analyse de `remote.origin.url` depuis `.git/config`
3. Appelle l'API publique de GitHub ou GitLab pour récupérer les données en direct (étoiles, licence, activité, etc.)
