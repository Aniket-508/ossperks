...
- <DynamicLink href="/[lang]/cli/check">check</DynamicLink> — verifique automaticamente a
  elegibilidade do seu repositório
- <DynamicLink href="/[lang]/cli/search">search</DynamicLink> — encontre programas por
  palavra-chave
