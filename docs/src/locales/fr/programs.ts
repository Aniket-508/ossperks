const programs = {
  ...
  listing: {
    description:
      "Outils gratuits, crédits et services disponibles pour les projets open source. Parcourez par catégorie et trouvez les programmes auxquels votre projet est éligible.",
    heading: "Programmes",
  },
  more: "+{count} de plus",
  sections: {
  ...
  submit: {
    ...
    description:
      "Vous avez un programme à suggérer ? Soumettez ses détails et nous l'ajouterons à la liste.",
    form: {
      addPerk: "Ajouter un avantage",
      addRequirement: "Ajouter une autre",
      addStep: "Ajouter une étape",
      applicationProcessHelp:
        "Décrivez chaque étape du processus de candidature.",
      ...
      eligibilityHelp:
        'Ajoutez une condition par champ (ex. "Projets open source", "Dépôt GitHub public").',
      ...
      tagsHelp:
        "Sélectionnez ou tapez pour ajouter des tags décrivant ce programme.",
      tagsLabel: "Tags",
