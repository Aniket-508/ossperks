const programs = {
  ...
  listing: {
    description:
      "오픈소스 프로젝트에 제공되는 무료 도구, 크레딧 및 서비스입니다. 카테고리별로 찾아보고 프로젝트에 적합한 프로그램을 찾아보세요.",
    heading: "프로그램",
  },
  more: "+{count}개 더보기",
  sections: {
  ...
  submit: {
    ...
    description:
      "제안하고 싶은 프로그램이 있으신가요? 세부 정보를 제출해 주시면 목록에 추가하겠습니다.",
    form: {
      addPerk: "혜택 추가",
      addRequirement: "추가하기",
      addStep: "단계 추가",
      ...
      eligibilityHelp:
        '필드당 하나의 요건을 추가하세요 (예: "오픈소스 프로젝트", "공개 GitHub 저장소").',
