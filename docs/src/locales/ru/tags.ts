const tags = {
  ...
  detail: {
    ...
    metaDescription:
      'Подборка лучших open source программ с тегом «{tag}». В каждой карточке — привилегии, критерии участия и шаги для подачи заявки.',
    metaTitle: 'Open source программы с тегом «{tag}»',
